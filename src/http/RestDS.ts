...
export class RestDS implements CRUD {
     ...
     */
    public $read(key: string, body?: any, customHeaders?: any): Promise<any | any[]> {
     ...
     */
    public $create(key: string, body: any, customHeaders: any): Promise<any | any[]> {
        return new Promise((resolve, reject) => {
            if (key) {
     ...
     */
    public $update(key: string, body: any, customHeaders: any): Promise<any | any[]> {
        return new Promise((resolve, reject) => {
            if (key) {
     ...
     */
    public $delete(key: string, body: any, customHeaders: any): Promise<any | any[]> {
        return new Promise((resolve, reject) => {
            if (key) {
     ...
     */
    public $fetch(method: string, resource: string, body: any, customHeaders: any): Promise<any | any[]> {
        return new Promise((resolve, reject) => {
            if (method && resource) {
